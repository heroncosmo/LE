@echo off
REM ========================================
REM IA VENDEDORA LUCHOA - INICIAR DIRETO
REM Sem Python - Apenas Node.js
REM ========================================

title IA Vendedora Luchoa - Servidor Direto
...
echo.
echo ========================================================================================================
echo  INICIANDO SERVIDOR NEXT.JS DIRETAMENTE...
echo  
